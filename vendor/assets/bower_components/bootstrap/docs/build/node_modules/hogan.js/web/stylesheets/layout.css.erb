...
.hogan-hero .noise {
	background: url(<%= asset_path 'bootstrap/docs/build/node_modules/hogan.js/web/images/noise.png' %>) repeat;
}
.hogan-hero .stripes {
	background: url(<%= asset_path 'bootstrap/docs/build/node_modules/hogan.js/web/images/stripes.png' %>) repeat;
}
...
.hogan-icon {
	...
	top: 46px;
	margin-left: -20px;
	background: url(<%= asset_path 'bootstrap/docs/build/node_modules/hogan.js/web/images/small-hogan-icon.png' %>) white no-repeat center center;
}
